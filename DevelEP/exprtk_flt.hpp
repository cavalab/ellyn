...
#ifndef INCLUDE_EXPRTK_FLT_HPP
#define INCLUDE_EXPRTK_FLT_HPP
     ...
     static const std::size_t pow10_size = sizeof(pow10) / sizeof(double);
      ...
      namespace numeric
      {
         ...
         namespace details
         {
            ...
            {
               return std::pow(static_cast<float>(v0),static_cast<float>(v1));
            }
            ...
            {
               return static_cast<T>(logn_impl<float>(static_cast<float>(v0),static_cast<float>(v1),real_type_tag()));
            }
            ...
            {
               return root_impl<float>(static_cast<float>(v0),static_cast<float>(v1),real_type_tag());
            }
            ...
            {
               return static_cast<T>(std::sqrt(static_cast<float>((v0 * v0) + (v1 * v1))));
            }
            ...
            {
               return erf_impl(static_cast<float>(v),real_type_tag());
            }
            ...
            {
               return erfc_impl(static_cast<float>(v),real_type_tag());
            }
   ...
   private:
      ...
      struct type_store
      {
         ...
         inline RawType& type_ref(const std::string& symbol_name)
         {
            struct init_type
            {
               static inline float set(long float)      { return (0.0);           }
